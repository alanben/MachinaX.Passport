...
/*	-----------------------------------------------------------------------
	...
	CREATE OR REPLACE FUNCTION x_UserLoginOld (
		@UserName varchar(30),
		@Password varchar(50),
		@Userid int OUTPUT
	)
	...
	CREATE OR REPLACE FUNCTION x_UserLoginAlt (
		@UserName varchar(30),
		@Password varchar(50),
		@Userid int OUTPUT
	)
	...
	CREATE OR REPLACE FUNCTION x_UserList (@GroupID int)
	/*	-----------------------------------------------------------------------
	...
	CREATE OR REPLACE FUNCTION x_UserProfileList (@UserID int)
	/*	-----------------------------------------------------------------------
		Procedure: Template
